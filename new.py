...
with st.sidebar:
    ...
    selected_language = st.selectbox("Start by Selecting your Language", ["English", "Assamese", "Bengali", "Gujarati", "Hindi", "Kannada", "Malayalam", "Marathi", 
...
if input_prompt:
    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking 💡..."):
            ...
            full_response += translated_answer  # Append the translated answer
