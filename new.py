...
st.header("SAHAB: Smart Assistant for Handling Advocacy and Briefings")
...
with st.sidebar:
    ...
    ["English", "Assamese", "Awadhi", "Bengali", "Bhojpuri", "Bodo", "Dogri", "Gujarati", "Hindi", "Kannada", "Khasi", "Kokborok", "Konkani", "Maithili", "Malayalam", "Marathi", "Marwadi", "Meiteilon (Manipuri)", "Mizo", "Nepali", "Odia", "Punjabi", "Sanskrit", "Santali", "Sindhi", "Tamil", "Telugu", "Tulu", "Urdu",
     "Spanish", "French", "German", "Chinese", "Japanese", "Korean", "Arabic", "Russian", "Portuguese", "Italian", "Turkish", "Dutch", "Swedish", "Hebrew", "Greek"])
